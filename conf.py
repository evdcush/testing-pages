...
# foofoo build configuration file, created by
# `ablog start` on Sun Jul  3 14:28:06 2022.
#
...
blog_authors = {
    "Evan Cushing": ("Evan Cushing", None),
}
